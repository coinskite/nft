function Footer() {
  return (
    <footer className='bg-[#0E0E0F] -mx-4 p-4 md:py-16 sm:-mx-8 sm:p-8 text-light'>
      <div className="grid grid-cols-2 md:grid-cols-6 text-sm">
        <div className="df flex-col justify-center text-center md:text-left lg:justify-start lg:items-start col-span-2 md:col-span-3">
          ...
          <p className="df">
            <img src="./assets/footer/twitter.png" alt="social" className='w-8' />
            <img src="./assets/footer/discord.png" alt="social" className='w-8' />
            <img src="./assets/footer/telegram.png" alt="social" className='w-8' />
            <img src="./assets/footer/medium.png" alt="social" className='w-8' />
            <img src="./assets/footer/youtube.png" alt="social" className='w-8' />
            <img src="./assets/footer/github.png" alt="social" className='w-8' />
          </p>
        </div>
