    ...
    >
      ...
      <div className="df flex-auto text-sm">
        ...
        <div className="flex-auto">
          <p>{title}</p>
          <p className="text-light df"><span className="text-xs">Floor price:</span> {point}</p>
        </div>

        <div className="text-right">
          <p className={isPulse ? 'text-primary' : profit !== "-" ? "text-[#EB5757]" : "text-light"}>{profit}</p>
          <p className="text-light">{avg}</p>
        </div>
      </div>
    </div>
  )
