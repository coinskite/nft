    ...
    <section>
      ...
      <div className='xl:grid grid-cols-[4rem_1fr_4rem] items-center justify-center'>
        ...
        <div className='md:max-w-6xl 2xl:max-w-7xl mx-auto'>
          ...
          >
            <SwiperSlide><div><img src="./assets/news/1.png" alt="news" /></div></SwiperSlide>
            <SwiperSlide><div><img src="./assets/news/2.png" alt="news" /></div></SwiperSlide>
            <SwiperSlide><div><img src="./assets/news/3.png" alt="news" /></div></SwiperSlide>
          </Swiper>
        </div>
